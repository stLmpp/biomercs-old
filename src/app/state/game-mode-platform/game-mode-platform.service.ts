...
import { GameModePlatform, GameModePlatformAddDto } from '../../model/game-mode-platform';
import { SuperService } from '../../shared/super/super-service';

@Injectable({ providedIn: 'root' })
export class GameModePlatformService extends SuperService<GameModePlatform, GameModePlatformAddDto> {
  constructor(
