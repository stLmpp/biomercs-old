...
import { GameModeCharacter, GameModeCharacterAddDto } from '../../model/game-mode-character';
import { SuperService } from '../../shared/super/super-service';

@Injectable({ providedIn: 'root' })
export class GameModeCharacterService extends SuperService<GameModeCharacter, GameModeCharacterAddDto> {
  constructor(
