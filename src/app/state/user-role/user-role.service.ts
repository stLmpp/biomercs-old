...
import { UserRole, UserRoleAddDto, UserRoleParamsDto } from '../../model/user-role';
import { HttpClient } from '@angular/common/http';
import { UserRoleStore } from './user-role.store';
import { UserRoleQuery } from './user-role.query';

@Injectable({ providedIn: 'root' })
export class UserRoleService extends SuperService<UserRole, UserRoleAddDto, any, any, UserRoleParamsDto> {
  constructor(
